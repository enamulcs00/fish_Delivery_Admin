  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["authentication-authentication-module"], {
    ...
    function srcAppAuthenticationAuthenticationModuleTs(module, __webpack_exports__, __webpack_require__) {
      ...
      AuthenticationModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
        ...
        imports: [[_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"].forChild(_authentication_routing__WEBPACK_IMPORTED_MODULE_13__["AuthenticationRoutes"]), _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_11__["MatCheckboxModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["ReactiveFormsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_12__["MatFormFieldModule"]]]
      });
      ...
      (function () {
        (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](AuthenticationModule, {
          ...
          imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_1__["RouterModule"], _ng_bootstrap_ng_bootstrap__WEBPACK_IMPORTED_MODULE_3__["NgbModule"], _angular_material_checkbox__WEBPACK_IMPORTED_MODULE_11__["MatCheckboxModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["FormsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_10__["ReactiveFormsModule"], _angular_material_form_field__WEBPACK_IMPORTED_MODULE_12__["MatFormFieldModule"]]
        });
      })();
      /*@__PURE__*/
    ...
    function srcAppAuthenticationLockChangepasswordComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function changepasswordComponent_mat_error_14_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function changepasswordComponent_mat_error_19_div_1_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function changepasswordComponent_mat_error_19_div_2_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function changepasswordComponent_mat_error_24_div_1_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 25);
      ...
      function changepasswordComponent_mat_error_24_div_2_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "div", 26);
      ...
      changepasswordComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function changepasswordComponent_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("ngModelChange", function changepasswordComponent_Template_input_ngModelChange_12_listener($event) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function changepasswordComponent_Template_a_click_29_listener() {
              return ctx.redirect();
            });
    ...
    function srcAppAuthenticationLogin2Login2ComponentTs(module, __webpack_exports__, __webpack_require__) {
      ...
      function Login2Component_span_14_Template(rf, ctx) {
        if (rf & 1) {
      ...
      function Login2Component_span_20_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 35);
      ...
      function Login2Component_span_47_Template(rf, ctx) {
        if (rf & 1) {
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵelementStart"](0, "span", 35);
      ...
      var Login2Component = /*#__PURE__*/function () {
        function Login2Component(route, _rout, formBuilder, Srvc, toastr) {
          var _this5 = this;
          ...
          this.submitted = false;
          this.loginform = true;
          this.recoverform = false; // Login Form error handling
          ...
          this.errorHandlingfog = function (control, error) {
            return _this5.forgotPass.controls[control].hasError(error);
          };
          ...
          value: function loginAdmin() {
            ...
            this.Srvc.login(data).subscribe(function (res) {
              if (res.statusCode == 200) {
                ...
                if (_this6.Uloginform.value.rememberMe) {
                  localStorage.setItem("remember", JSON.stringify(_this6.Uloginform.value));
                } else {
          ...
          value: function forgotPassword() {
            ...
            if (this.forgotPass.valid) {
              this.Srvc.forgotPassword(data).subscribe(function (res) {
                if (res.statusCode == 200) {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire(_this7.forgotPass.controls["forgotname"].value, "Password reset link sent on email", "success");

                  _this7.forgotPass.reset();

                  _this7.loginform = true;
                  _this7.recoverform = false;
                } else {
                  sweetalert2__WEBPACK_IMPORTED_MODULE_3___default.a.fire("Oops", res.message, "error");
                }
              });
      ...
      Login2Component.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
        ...
        template: function Login2Component_Template(rf, ctx) {
          if (rf & 1) {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Login2Component_Template_button_click_32_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Login2Component_Template_button_click_50_listener() {
            ...
            _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function Login2Component_Template_button_click_52_listener() {
              return ctx.back();
            });
