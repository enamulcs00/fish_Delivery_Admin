...
ChatComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({ type: ChatComponent, selectors: [["ng-component"]], decls: 52, vars: 9, consts: [[1, "right-part", "ml-0", "w-100"], [1, "card"], [1, "p-l-20", "p-r-25", "p-t-25", "p-b-25", "bg-info", "d-flex", "align-items-center"], ["width", "45", "alt", "user", 1, "rounded-circle", 3, "src"], [1, "text-white", "m-b-0", "m-l-15", "font-18"], [1, "card-body", "p-t-0", "p-r-0"], [1, "chat-box", "p-r-15", 2, "height", "calc(100vh - 300px)", "position", "relative", 3, "perfectScrollbar"], [1, "chat-list"], [1, "chat-item"], [1, "chat-img"], ["alt", "user", 3, "src"], [1, "chat-content"], [1, "font-medium"], [1, "box", "bg-light-info"], [1, "chat-time"], [1, "odd", "chat-item"], [1, "box", "bg-light-inverse"]], template: function ChatComponent_Template(rf, ctx) { if (rf & 1) {
